...
```
__OUTPUT GRAPH:__
<img width="1390" height="812" alt="image" src="https://github.com/user-attachments/assets/72be8414-2ea0-49cf-9584-d7f7b94294aa" />
__RESULT:__
Thus,mean, variance and cross correlation are executed SCILAB and the output is verified. 
